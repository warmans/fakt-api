...
func (r *ProcessRunner) Run(db *dbr.Session) {
...
func GetActivityRunner(interval time.Duration, logger log.Logger) *ProcessRunner {
	return &ProcessRunner{processor: &Activity{}, interval: interval, logger: logger}
}
